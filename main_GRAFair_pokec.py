...
from dataset_pokec import load_data, load_data_cf, load_data_rb
...
# load robustness data
    ...
    data_rb.s = data_rb['region'].float()
...
if is_model_trained:
    ...
    log_df['sensitive'] = sensitive_attr
...
if is_model_trained:
    ...
    log_std['sensitive'] = sensitive_attr
